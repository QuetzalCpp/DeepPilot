...
class DeepPilot:
	...
	def __init__(self):
		...
		model1.load_weights('models/models_4img/4img_roll_pitch_model.h5')
		...
		model2.load_weights('models/models_4img/4img_altitude_model.h5')
		...
		model3.load_weights('models/models_4img/4img_yaw_model.h5')
	...
	def callback(self,data):
		...
		if len(self.q) < 4 and self.frame_cont == 3: 
		...
		if len(self.q) == 3:
			...
			self.outputImage = np.zeros((720,1280, 3), dtype="uint8")
		
			self.outputImage[0:360, 0:640] = self.q[0]
			self.outputImage[0:360, 640:1280] = self.q[1]
			
			self.outputImage[360:720, 0:640] = self.q[2]
			self.outputImage[360:720, 640:1280] = frame
