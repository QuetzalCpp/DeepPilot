...
class DeepPilot:
	...
	def __init__(self):
		...
		model1.load_weights('models/models_2img/2img_roll_pitch_model.h5')
		...
		model2.load_weights('models/models_2img/2img_altitude_model.h5')
		...
		model3.load_weights('models/models_2img/2img_yaw_model.h5')
	...
	def callback(self,data):
		...
		if len(self.q) < 2 and self.frame_cont == 1: 
		...
		if len(self.q) == 1:
			...
			self.outputImage = np.zeros((360,1280, 3), dtype="uint8")
		
			self.outputImage[0:360, 0:640] 		=	self.q[0]
			self.outputImage[0:360, 640:1280]	= 	frame
